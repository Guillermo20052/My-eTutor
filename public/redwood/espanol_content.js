/* =====================================================================
  ...
  const ESPANOL_BANK = {
    ...
    fill: [
      ...
      { topic: "z-c-s", prompt: "ofi_ina", answer: "c", hint: "'Oficina' antes de i → c." },
      { topic: "z-c-s", prompt: "_orro", answer: "z", hint: "El 'zorro', con z." },
      { topic: "z-c-s", prompt: "pa_iencia", answer: "c", hint: "'Paciencia' antes de i → c." },
      { topic: "z-c-s", prompt: "ri_o (del cabello)", answer: "z", hint: "El 'rizo' del cabello, con z." },
      { topic: "z-c-s", prompt: "li_o", answer: "s", hint: "'Liso' (sin arrugas), con s." },
      { topic: "z-c-s", prompt: "ta_a", answer: "z", hint: "La 'taza' para tomar, con z." },
      { topic: "z-c-s", prompt: "na_ión", answer: "c", hint: "Termina en -ción → c." },
      { topic: "z-c-s", prompt: "do_e", answer: "c", hint: "El número 'doce', con c." },
      { topic: "z-c-s", prompt: "a_úcar", answer: "z", hint: "El 'azúcar', con z." },
      { topic: "z-c-s", prompt: "feli_idad", answer: "c", hint: "'Felicidad' antes de i → c." },
      { topic: "c-qu-k", prompt: "_iosco", answer: "k", hint: "El 'kiosco', con k." },
      { topic: "c-qu-k", prompt: "par_e", answer: "qu", hint: "El 'parque' → qu." },
      { topic: "c-qu-k", prompt: "_eso (alimento)", answer: "qu", hint: "El 'queso' → qu." },
      { topic: "c-qu-k", prompt: "cho_olate", answer: "c", hint: "'Chocolate' /k/ antes de o → c." },
      { topic: "c-qu-k", prompt: "ar_a (de Noé)", answer: "c", hint: "El 'arca' /k/ antes de a → c." },
      { topic: "c-qu-k", prompt: "ma_eta (modelo a escala)", answer: "qu", hint: "La 'maqueta' → qu antes de e." },
      { topic: "c-qu-k", prompt: "blo_e", answer: "qu", hint: "El 'bloque' → qu." },
      { topic: "c-qu-k", prompt: "kara_e (deporte)", answer: "t", hint: "El 'karate'." },
      { topic: "c-qu-k", prompt: "peli_ula", answer: "c", hint: "'Película' /k/ antes de u → c." },
      { topic: "c-qu-k", prompt: "_etchup", answer: "k", hint: "El 'ketchup', con k." },
      { topic: "c-qu-k", prompt: "ata_e", answer: "qu", hint: "El 'ataque' → qu." },
      { topic: "c-qu-k", prompt: "_oche", answer: "c", hint: "El 'coche' /k/ antes de o → c." },
      { topic: "c-qu-k", prompt: "ban_ete", answer: "qu", hint: "El 'banquete' → qu." },
      { topic: "c-qu-k", prompt: "_imono", answer: "k", hint: "El 'kimono', con k." },
      { topic: "c-qu-k", prompt: "ra_eta", answer: "qu", hint: "La 'raqueta' → qu." },
      { topic: "homofonas", prompt: "_iento (del aire)", answer: "v", hint: "El 'viento' → v." },
      { topic: "homofonas", prompt: "_aca (animal de la granja)", answer: "v", hint: "La 'vaca' → v." },
      { topic: "homofonas", prompt: "gra_e (serio)", answer: "v", hint: "'Grave' → con v." },
      { topic: "homofonas", prompt: "sa_er (conocer)", answer: "b", hint: "El verbo 'saber' → b." },
      { topic: "homofonas", prompt: "_aca (animal)", answer: "v", hint: "La 'vaca' → v." },
      { topic: "homofonas", prompt: "_aca (de baca, portaequipaje)", answer: "b", hint: "La 'baca' del coche → b." },
      { topic: "homofonas", prompt: "hi_o (de hacer)", answer: "z", hint: "'Hizo' del verbo hacer → z." },
      { topic: "homofonas", prompt: "hi_o (del verbo hacer)", answer: "z", hint: "'Hizo' viene de hacer → z." },
    ],
    ...
    error: [
      ...
      { topic: "mayusculas", tokens: ["fui", "al", "cine", "con", "laura."], badIndex: 4, fixed: "Laura", why: "Nombre propio → mayúscula." },
      { topic: "mayusculas", tokens: ["el", "río", "amazonas", "es", "enorme."], badIndex: 2, fixed: "Amazonas", why: "Nombre propio (río) → mayúscula." },
      { topic: "mayusculas", tokens: ["nos", "vemos", "el", "Martes."], badIndex: 3, fixed: "martes.", why: "Los días van en minúscula." },
      { topic: "mayusculas", tokens: ["pedro", "y", "yo", "jugamos."], badIndex: 0, fixed: "Pedro", why: "Nombre propio e inicio → mayúscula." },
      { topic: "mayusculas", tokens: ["vivo", "en", "la", "ciudad", "de", "méxico."], badIndex: 5, fixed: "México.", why: "Nombre propio → mayúscula." },
      { topic: "mayusculas", tokens: ["mañana", "es", "Miércoles."], badIndex: 2, fixed: "miércoles.", why: "Los días van en minúscula." },
      { topic: "mayusculas", tokens: ["leí", "el", "libro", "el", "Quijote."], badIndex: 4, fixed: "Quijote.", why: "Nombre propio en el título → mayúscula." },
      { topic: "mayusculas", tokens: ["mi", "perro", "corre", "en", "el", "Parque."], badIndex: 5, fixed: "parque.", why: "'Parque' es común → minúscula." },
      { topic: "mayusculas", tokens: ["el", "océano", "Pacífico", "es", "grande."], badIndex: 1, fixed: "Océano", why: "Inicia el nombre propio 'Océano Pacífico'." },
      { topic: "mayusculas", tokens: ["fuimos", "a", "Veracruz", "en", "Diciembre."], badIndex: 4, fixed: "diciembre.", why: "Los meses van en minúscula." },
      { topic: "mayusculas", tokens: ["sofía", "habla", "tres", "idiomas."], badIndex: 0, fixed: "Sofía", why: "Nombre propio e inicio → mayúscula." },
      { topic: "mayusculas", tokens: ["el", "gato", "de", "María", "duerme."], badIndex: 0, fixed: "El", why: "Inicio de oración → mayúscula." },
      { topic: "mayusculas", tokens: ["nací", "un", "domingo", "de", "Verano."], badIndex: 4, fixed: "verano.", why: "Las estaciones van en minúscula." },
      { topic: "mayusculas", tokens: ["el", "monte", "Everest", "es", "alto."], badIndex: 1, fixed: "Monte", why: "Inicia el nombre propio 'Monte Everest'." },
      { topic: "mayusculas", tokens: ["compré", "pan", "en", "la", "Panadería."], badIndex: 4, fixed: "panadería.", why: "'Panadería' es común → minúscula." },
      { topic: "mayusculas", tokens: ["el", "presidente", "habló", "ayer."], badIndex: 0, fixed: "El", why: "Inicio de oración → mayúscula." },
      { topic: "mayusculas", tokens: ["visité", "el", "museo", "del", "Prado."], badIndex: 4, fixed: "Prado.", why: "Nombre propio del museo → mayúscula." },
      { topic: "mayusculas", tokens: ["juan", "vive", "cerca", "de", "aquí."], badIndex: 0, fixed: "Juan", why: "Nombre propio e inicio → mayúscula." },
      { topic: "mayusculas", tokens: ["el", "perro", "ladra", "mucho"], badIndex: 0, fixed: "El", why: "Inicio de oración → mayúscula." },
      { topic: "mayusculas", tokens: ["hoy", "es", "jueves", "cinco", "de", "Mayo."], badIndex: 5, fixed: "mayo.", why: "Los meses van en minúscula." },
      { topic: "mayusculas", tokens: ["estudio", "en", "la", "escuela", "Benito", "juárez."], badIndex: 5, fixed: "Juárez.", why: "Nombre propio → mayúscula." },
      { topic: "mayusculas", tokens: ["mi", "tía", "ana", "es", "doctora."], badIndex: 2, fixed: "Ana", why: "Nombre propio → mayúscula." },
      { topic: "signos", tokens: ["Cuántos", "años", "tienes?"], badIndex: 0, fixed: "¿Cuántos", why: "Falta el signo de apertura ¿." },
      { topic: "signos", tokens: ["Qué", "rico", "está", "esto!"], badIndex: 0, fixed: "¡Qué", why: "Falta el signo de apertura ¡." },
      { topic: "signos", tokens: ["Traje", "lápices", "plumas", "y", "gomas."], badIndex: 1, fixed: "lápices,", why: "Enumeración: lápices, plumas y gomas." },
      { topic: "signos", tokens: ["¿Vienes", "a", "la", "fiesta."], badIndex: 3, fixed: "fiesta?", why: "Una pregunta cierra con ?." },
      { topic: "signos", tokens: ["Cuidado", "con", "el", "escalón!"], badIndex: 0, fixed: "¡Cuidado", why: "Exclamación: falta ¡ al inicio." },
      { topic: "signos", tokens: ["Quiero", "manzana", "plátano", "y", "uva."], badIndex: 1, fixed: "manzana,", why: "Enumeración: manzana, plátano y uva." },
      { topic: "signos", tokens: ["Dónde", "dejaste", "el", "libro?"], badIndex: 0, fixed: "¿Dónde", why: "Falta el signo de apertura ¿." },
      { topic: "signos", tokens: ["¡Qué", "emoción."], badIndex: 1, fixed: "emoción!", why: "Una exclamación cierra con !." },
      { topic: "signos", tokens: ["Por", "qué", "lloras?"], badIndex: 0, fixed: "¿Por", why: "Falta ¿ al inicio de la pregunta." },
      { topic: "signos", tokens: ["Compré", "leche", "huevos", "pan", "y", "queso."], badIndex: 1, fixed: "leche,", why: "Enumeración: leche, huevos, pan y queso." },
      { topic: "signos", tokens: ["Qué", "día", "tan", "largo!"], badIndex: 0, fixed: "¡Qué", why: "Falta ¡ al inicio." },
      { topic: "signos", tokens: ["¿Te", "gusta", "el", "helado"], badIndex: 3, fixed: "helado?", why: "La pregunta cierra con ?." },
      { topic: "signos", tokens: ["Cómo", "se", "escribe", "esto?"], badIndex: 0, fixed: "¿Cómo", why: "Falta ¿ al inicio." },
      { topic: "signos", tokens: ["Tengo", "rojo", "azul", "y", "verde."], badIndex: 1, fixed: "rojo,", why: "Enumeración: rojo, azul y verde." },
      { topic: "signos", tokens: ["¡Felicidades."], badIndex: 0, fixed: "¡Felicidades!", why: "Una exclamación cierra con !." },
      { topic: "signos", tokens: ["Quién", "es", "esa", "persona?"], badIndex: 0, fixed: "¿Quién", why: "Falta ¿ al inicio." },
      { topic: "signos", tokens: ["Visité", "París", "Roma", "y", "Madrid."], badIndex: 1, fixed: "París,", why: "Enumeración: París, Roma y Madrid." },
      { topic: "signos", tokens: ["Cuándo", "llegaste", "a", "casa?"], badIndex: 0, fixed: "¿Cuándo", why: "Falta ¿ al inicio." },
      { topic: "signos", tokens: ["Qué", "susto", "me", "diste!"], badIndex: 0, fixed: "¡Qué", why: "Falta ¡ al inicio." },
      { topic: "signos", tokens: ["¿Quieres", "agua", "o", "jugo."], badIndex: 3, fixed: "jugo?", why: "La pregunta cierra con ?." },
      { topic: "signos", tokens: ["Necesito", "tijeras", "papel", "y", "pegamento."], badIndex: 1, fixed: "tijeras,", why: "Enumeración: tijeras, papel y pegamento." },
      { topic: "signos", tokens: ["Cuánto", "cuesta", "el", "boleto?"], badIndex: 0, fixed: "¿Cuánto", why: "Falta ¿ al inicio." },
      { topic: "concordancia", tokens: ["el", "sillas", "cómodas"], badIndex: 0, fixed: "las", why: "Femenino plural: 'las sillas cómodas'." },
      { topic: "concordancia", tokens: ["una", "coche", "rojo"], badIndex: 0, fixed: "un", why: "Masculino: 'un coche rojo'." },
      { topic: "concordancia", tokens: ["los", "niña", "pequeñas"], badIndex: 0, fixed: "las", why: "Femenino plural: 'las niñas pequeñas'." },
      { topic: "concordancia", tokens: ["la", "árboles", "altos"], badIndex: 0, fixed: "los", why: "Masculino plural: 'los árboles altos'." },
      { topic: "concordancia", tokens: ["mis", "cuaderno", "nuevos"], badIndex: 1, fixed: "cuadernos", why: "Plural: 'mis cuadernos nuevos'." },
      { topic: "concordancia", tokens: ["unas", "gato", "negros"], badIndex: 0, fixed: "unos", why: "Masculino plural: 'unos gatos negros'... y 'gatos'." },
      { topic: "concordancia", tokens: ["el", "mochila", "azul"], badIndex: 0, fixed: "la", why: "Femenino: 'la mochila azul'." },
      { topic: "concordancia", tokens: ["los", "flor", "bonitas"], badIndex: 0, fixed: "las", why: "Femenino plural: 'las flores bonitas'." },
      { topic: "concordancia", tokens: ["una", "mapa", "grande"], badIndex: 0, fixed: "un", why: "'Mapa' es masculino: 'un mapa grande'." },
      { topic: "concordancia", tokens: ["el", "casas", "viejas"], badIndex: 0, fixed: "las", why: "Femenino plural: 'las casas viejas'." },
      { topic: "concordancia", tokens: ["mis", "amiga", "favoritas"], badIndex: 1, fixed: "amigas", why: "Plural: 'mis amigas favoritas'." },
      { topic: "concordancia", tokens: ["los", "mesa", "redondas"], badIndex: 0, fixed: "las", why: "Femenino plural: 'las mesas redondas'." },
      { topic: "concordancia", tokens: ["la", "día", "soleado"], badIndex: 0, fixed: "el", why: "'Día' es masculino: 'el día soleado'." },
      { topic: "concordancia", tokens: ["unos", "manzana", "verdes"], badIndex: 1, fixed: "manzanas", why: "Plural: 'unas manzanas verdes'." },
      { topic: "concordancia", tokens: ["el", "plumas", "azules"], badIndex: 0, fixed: "las", why: "Femenino plural: 'las plumas azules'." },
      { topic: "concordancia", tokens: ["la", "problema", "resuelto"], badIndex: 0, fixed: "el", why: "'Problema' es masculino: 'el problema resuelto'." },
      { topic: "concordancia", tokens: ["los", "ventana", "abiertas"], badIndex: 0, fixed: "las", why: "Femenino plural: 'las ventanas abiertas'." },
      { topic: "concordancia", tokens: ["una", "lápiz", "afilado"], badIndex: 0, fixed: "un", why: "Masculino: 'un lápiz afilado'." },
      { topic: "concordancia", tokens: ["el", "estrellas", "brillantes"], badIndex: 0, fixed: "las", why: "Femenino plural: 'las estrellas brillantes'." },
      { topic: "concordancia", tokens: ["mis", "zapato", "cómodos"], badIndex: 1, fixed: "zapatos", why: "Plural: 'mis zapatos cómodos'." },
      { topic: "concordancia", tokens: ["la", "libros", "interesantes"], badIndex: 0, fixed: "los", why: "Masculino plural: 'los libros interesantes'." },
      { topic: "homofonas", tokens: ["No", "se", "si", "vendrá."], badIndex: 2, fixed: "sé", why: "'Sé' (del verbo saber) lleva tilde diacrítica." },
      { topic: "homofonas", tokens: ["Dame", "mas", "pan,", "por", "favor."], badIndex: 1, fixed: "más", why: "'Más' (cantidad) lleva tilde." },
      { topic: "homofonas", tokens: ["Tu", "eres", "mi", "amigo."], badIndex: 0, fixed: "Tú", why: "'Tú' (persona) lleva tilde diacrítica." },
    ],
  };
